...
if(isset($_REQUEST['edit_id']))
{
  ...
  $query="select * from courses where course_code='$edit_id' ";
...
{
	$course_code=$_POST['c_id'];
	$course_details=$_POST['c_name'];
	$course_section=$_POST['section'];
	$faculty_id=$_POST['f_id'];
	$faculty_initials=$_POST['init'];

$query = "update courses set  course_details='$course_details', section='$course_section' where course_code='$course_code' ";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                ...
                <div class="row">
                   ...
                   <h1>Course <?php echo $edit_id;?> UPDATE </h1>
   <form  method="POST" action="l_course_edit.php">

   	<div class="form-group">
                        <label for="course_id">Course Code:</label>
                        <input  type="text" class="form-control"  name="c_id" value="<?php echo $course_code?>">
                      </div>

                    <div class="form-group">
                        <label for="course_id">Course Details:</label>
                        <input  type="text" class="form-control"  name="c_name" value="<?php echo $course_details?>">
                      </div>

                          <div class="form-group">
                              <label for="course_id">Section Number</label>
                              <input  type="text" class="form-control"  name="section" value="<?php echo $course_section?>">
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <input  type="text" class="form-control" name="init" value="<?php echo $faculty_initials?>">
