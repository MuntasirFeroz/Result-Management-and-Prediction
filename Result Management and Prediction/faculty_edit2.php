...
if(isset($_REQUEST['edit_id']))
{
  ...
  $query="select * from faculty_users where faculty_id='$edit_id' ";
...
if(isset($_POST['submit']))
{
  ...
  $faculty_initials=$_POST['initials'];
  ...
  #$query="update faculty_users set first_name='$first_name' where faculty_id='$faculty_id' ";

  $query = "update faculty_users set first_name='$first_name', last_name='$last_name', initials='$faculty_initials', contact='$contact', email='$email' where faculty_id='$faculty_id' ";
  #$query="update faculty_users set first_name='$first_name', last_name='$last_name',initials='$faculty_initials', contact='$contact',email='$email' where faculty_id='$faculty_id' ";
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
						...
						<h1>Faculty <?php echo $edit_id;?> UPDATE </h1>
   <form  method="POST" action="faculty_edit2.php">
                    
              <div class="form-group">
                        <label for="course_id">Faculty ID:</label>
                        <input  type="text" class="form-control"  name="f_id" value="<?php echo $faculty_id?>">
                      </div>
                    ...
                    <div class="form-group">
                        ...
                        <input  type="text" class="form-control"  name="f_name" value="<?php echo $first_name?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="course_id">Initials:</label>
                              <input  type="text" class="form-control" name="initials" value="<?php echo $faculty_initials?>">
                            </div>

                            <div class="form-group">
                              <label for="course_id">Contact</label>
                              <input  type="text" class="form-control" name="contact" value="<?php echo $contact?>"></div>

                            <div class="form-group">
                              <label for="course_id">Email</label>
