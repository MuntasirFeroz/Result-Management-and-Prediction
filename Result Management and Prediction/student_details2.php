            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                              ...
                              <form class="form-inline"action="student_search2.php" method="POST">
                              <!-- <label>Student Id</label> -->
                                <div class="form-group">
                              
                              <input type="text" class="form-control" name="search_id" placeholder="Enter Student id">
                                <button type="submit" class="btn btn-default" name="student_search"> <span class="glyphicon glyphicon-search"></span> SEARCH
                              </button>
                            </div>
