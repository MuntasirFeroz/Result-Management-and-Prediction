            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                              ...
                              <form class="form-inline"action="faculty_search2.php" method="POST">
                              <!-- <label>Student Id</label> -->
                                <div class="form-group">
                              
                              <input type="text" class="form-control" name="search_id" placeholder="Enter Faculty id">
                                <button type="submit" class="btn btn-default" name="faculty_search"> <span class="glyphicon glyphicon-search"></span> SEARCH
                              </button>
                            </div>
