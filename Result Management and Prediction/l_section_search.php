...
<div class="dropdown">
 ...
 <div id="wrapper">
    ...
    <!-- /#sidebar -->
      ...
      <?php
        ...
        if(isset($_REQUEST['delete_id']))
        {
          ...
          #echo $delete_id;
          $query="delete from courses where course_code ='$delete_id' ";  
          mysqli_query($con,$query);   
          echo "<script> window.open('show_courses.php','_self')</script>";     
        }

        if(isset($_POST['course_search']))
          {
            $search_by_id=$_POST['search_course_id'];

            $query="select * from courses where course_code ='$search_by_id' ";
            ...
            while($row=mysqli_fetch_array($result))
		{
		  ...
		  $course_section=$row['section'];
            ...
            <!--<td> <a href='course_search.php?delete_id=$course_code'> DELETE</a></td>
            <td> <a href='l_course_edit.php?edit_id=$course_code'>EDIT</a></td>-->
					</tr>
				";
    ...
    ?>
        <br>
        <button class="btn btn-default"> <a href="show_sections.php" style="text-decoration: none;">Go Back </a> </button>   
